...
export default function InviteLinkGenerator({ basePath = "/Nhi/", gradName = "Tố Nhi" }) {
  const [guestName, setGuestName] = useState("");
  const [copied, setCopied] = useState(false);
  const [copiedMsg, setCopiedMsg] = useState(false);

  // Lấy origin hiện tại hoặc fallback sang domain thật
  ...
  return (
    <div className="bg-white border border-border-solid rounded-xl p-6 mb-8 shadow-sm transition-all hover:shadow-md">
      ...
      {/* Các nút hành động: Xem, Sao chép, Chia sẻ */}
