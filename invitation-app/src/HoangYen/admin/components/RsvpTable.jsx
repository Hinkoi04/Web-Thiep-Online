  ...
  return (
    <>
      <div className="flex items-center justify-between mb-4">
        <h2 className="font-cormorant text-[1.2rem] text-dark tracking-[0.02em]">
          {isTrash ? "Lời Chúc Trong Thùng Rác" : "Khách Mời Đã Gửi Lời Chúc"}
        </h2>
        <span className="text-[0.75rem] text-muted bg-cream-dark py-1 px-3 rounded-full tracking-[0.05em]">
          {total} lời chúc
        </span>
      </div>
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-cream border-b border-border-solid">
                <th width="20%" className="py-3.5 px-5 text-left text-[0.65rem] tracking-[0.2em] uppercase text-muted font-semibold whitespace-nowrap">
                  Khách Mời
                </th>
                <th className="py-3.5 px-5 text-left text-[0.65rem] tracking-[0.2em] uppercase text-muted font-semibold whitespace-nowrap">
                  Lời Chúc
                </th>
                <th width="16%" className="py-3.5 px-5 text-left text-[0.65rem] tracking-[0.2em] uppercase text-muted font-semibold whitespace-nowrap">
                  Thời Gian
                </th>
                <th width="16%" className="py-3.5 px-5 text-left text-[0.65rem] tracking-[0.2em] uppercase text-muted font-semibold whitespace-nowrap">
                  Thao Tác
                    ...
                    >
                      <td className="py-4.5 px-5 align-top">
                        <div className="flex items-center gap-3">
                          <div className="w-9 h-9 bg-gradient-to-br from-gold-light to-gold-dark rounded-full inline-flex items-center justify-center text-white font-semibold text-[0.85rem] shrink-0">
                            {firstChar}
                          </div>
                          <span className="font-medium text-dark text-[0.95rem] whitespace-nowrap">
                            {row.guest_name}
                          </span>
                        </div>
                      </td>
                      <td className="py-4.5 px-5 align-top">
                        <span className="font-cormorant text-[2rem] text-gold-light leading-[0.5] align-[-0.4em] mr-0.5">
                          "
                        </span>
                        <span className="text-text-admin text-[1rem] leading-[1.65] whitespace-pre-wrap break-words italic font-cormorant">
                ...
                <tr>
                  <td colSpan="4" className="py-4.5 px-5 align-top">
                    <div className="py-20 px-5 text-center">
                      <div className="text-[3rem] mb-4 opacity-40">{isTrash ? "🗑️" : "📭"}</div>
                      <div className="font-cormorant text-[1.4rem] text-muted mb-1.5">
                        {isTrash ? "Thùng rác trống" : "Chưa có lời chúc nào"}
                      </div>
                      <div className="text-[0.8rem] text-[rgba(122,109,94,0.6)] tracking-[0.05em]">
      ...
      {viewMsg && (
        <div
          className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm transition-opacity p-4"
          ...
          >
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="bg-[#fdfaf6] border border-[#e8d5a3]/30 rounded-lg p-5 md:p-6 relative">
                <span className="absolute top-2 left-3 font-cormorant text-[4rem] text-gold-light opacity-20 leading-none">
                  "
                </span>
                ...
                <span className="absolute bottom-[-1.5rem] right-3 font-cormorant text-[4rem] text-gold-light opacity-20 leading-none rotate-180">
                  "
                </span>
              </div>
            </div>
